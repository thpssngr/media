...
snatch = media.Movie("Snatch",
                    ...
                    "2000",
                    "https://upload.wikimedia.org/wikipedia/en/a/a7/Snatch_ver4.jpg",  # noqa
                    "https://www.youtube.com/watch?v=9Jar2XkBboo")

revolver = media.Movie("Revolver",
                    "a movie about gambling",
                    "2005",
                    "https://upload.wikimedia.org/wikipedia/en/b/b6/Revolver2005.jpg",  # noqa
                    "https://www.youtube.com/watch?v=M9JAYfZOHms")

lockstock = media.Movie("Lock Stock and two smoking Barrels",
                    "a movie about old guns",
                    "1998",
                    "https://upload.wikimedia.org/wikipedia/en/e/e9/Lock%2C_Stock_and_Two_Smoking_Barrels_2.jpg",  # noqa
                    "https://www.youtube.com/watch?v=KZh33gGK3Y8")

rocknrolla = media.Movie("RocknRolla",
                    "a movie about diamonds",
                    "2008",
                    "https://upload.wikimedia.org/wikipedia/en/9/98/Rocknrolla_ver3.jpg",  # noqa
...
sherlock_gos = media.Movie("Sherlock Holmes - Game of Shadows",
                    ...
                    "2011",
                    "https://upload.wikimedia.org/wikipedia/en/5/53/Sherlock_Holmes2Poster.jpg",  # noqa
